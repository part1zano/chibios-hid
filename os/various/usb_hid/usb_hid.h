/*
*   Header file for Chibios/RT USB-HID Support
*   Copyright (C) [2012, +inf]  Roberto (formica) Marino
*   formica@member.fsf.org
*
*   This code is FREE SOFTWARE, and is released under the terms 
...
#define HID_USAGE_PAGE(up) 		(uint8_t)(0x05 & 255),(uint8_t)(((up) >> 8) & 255)
#define HID_USAGE(u) 	   		(uint8_t)(0x09 & 255),(uint8_t)(((u) >> 8) & 255)
#define HID_COLLECTION(c)  		(uint8_t)(0xA1 & 255),(uint8_t)(((c) >> 8) & 255)
#define HID_END_COLLECTION		0xC0,0x00

#define HID_USAGE_MINIMUM(x)  		(uint8_t)(0x19 & 255),(uint8_t)(((x) >> 8) & 255)
#define HID_USAGE_MAXIMUM(x)  		(uint8_t)(0x29 & 255),(uint8_t)(((x) >> 8) & 255)
#define HID_LOGICAL_MINIMUM(x)  	(uint8_t)(0x15 & 255),(uint8_t)(((x) >> 8) & 255)
#define HID_LOGICAL_MAXIMUM(x)  	(uint8_t)(0x25 & 255),(uint8_t)(((x) >> 8) & 255)
#define HID_REPORT_COUNT(x)  		(uint8_t)(0x95 & 255),(uint8_t)(((x) >> 8) & 255)
#define HID_REPORT_SIZE(x)  		(uint8_t)(0x75 & 255),(uint8_t)(((x) >> 8) & 255)
#define HID_INPUT(x)  			(uint8_t)(0x81 & 255),(uint8_t)(((x) >> 8) & 255)
